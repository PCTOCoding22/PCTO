...
int main(int argc, char **argv)
{
    ...
    for( int numero_x = 0 ; numero_x < size_x; numero_x = numero_x + 1)
    {
        for ( int numero_y = 0 ; numero_y < size_y; numero_y = numero_y + 1)
        {
            if(numero_y % 2 != 0)
            {
            
             put_pixel(numero_x, numero_y, canvas);
            
            }
            else if(numero_x % 2 == 0)
            {
             put_pixel(numero_x, numero_y, canvas);
